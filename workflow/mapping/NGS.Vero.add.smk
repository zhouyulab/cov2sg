...
RNA_TP_BASE = os.path.join("analysis", "RNA_seq_TP")
RNA_TP_SAMPLE = {"4h": ["rep1", "rep2"], "6h": ["rep1", "rep2"], "12h": ["part1"], "24h": ["part1", "part2"]}


rule RNA_cutadapt_TP:
    input:
        fastq_R1 = os.path.join("data", "RNAseqFastq", "WIV04.{tp}.{part}.R1.fastq.gz"),
        fastq_R2 = os.path.join("data", "RNAseqFastq", "WIV04.{tp}.{part}.R2.fastq.gz"),
    output:
